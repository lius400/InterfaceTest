...
casedir = os.path.abspath(os.path.dirname(os.path.dirname(__file__)))+"/Data/TestData.xlsx"
resultdir =  os.path.abspath(os.path.dirname(os.path.dirname(__file__)))+"/result/ResultData.xlsx"
